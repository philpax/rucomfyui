...
impl crate::nodes::TypedNode for ClipVisionLoader {
    ...
    fn output(&self) -> Self::Output {
        Self::Output {
            clip_vision: crate::nodes::ClipVisionOut(0usize),
        }
    }
...
impl crate::nodes::TypedNode for GligenLoader {
    ...
    fn output(&self) -> Self::Output {
        Self::Output {
            gligen: crate::nodes::GligenOut(0usize),
        }
    }
...
impl crate::nodes::TypedNode for StyleModelLoader {
    ...
    fn output(&self) -> Self::Output {
        Self::Output {
            style_model: crate::nodes::StyleModelOut(0usize),
        }
    }
...
impl crate::nodes::TypedNode for UpscaleModelLoader {
    ...
    fn output(&self) -> Self::Output {
        Self::Output {
            upscale_model: crate::nodes::UpscaleModelOut(0usize),
        }
    }
...
impl crate::nodes::TypedNode for UnClipCheckpointLoader {
    ...
    fn output(&self) -> Self::Output {
        Self::Output {
            ...
            clip: crate::nodes::ClipOut(1usize),
            vae: crate::nodes::VaeOut(2usize),
            clip_vision: crate::nodes::ClipVisionOut(3usize),
        }
    }
