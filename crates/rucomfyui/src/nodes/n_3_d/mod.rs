...
> Preview3D<ModelFileParam, CameraInfoParam, BgImageParam> {
    /// Create a new node.
    pub fn new(
...
impl<
    ...
    CameraInfoParam: crate::nodes::types::Load3DCamera,
    BgImageParam: crate::nodes::types::Image,
> crate::nodes::TypedNode for Preview3D<ModelFileParam, CameraInfoParam, BgImageParam> {
...
for Preview3D<ModelFileParam, CameraInfoParam, BgImageParam> {}
