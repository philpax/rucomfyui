...
for IdeogramV1<PromptParam, TurboParam, SeedParam, NegativePromptParam, NumImagesParam> {
    ...
    const CATEGORY: &'static str = "partner/image/Ideogram";
}
...
///**Ideogram V4**: Generates images using the Ideogram 4.0 model from a text prompt.
#[derive(Clone)]
#[allow(non_camel_case_types)]
pub struct IdeogramV4<
    PromptParam: crate::nodes::types::String,
    SeedParam: crate::nodes::types::Int,
> {
...
impl<
    PromptParam: crate::nodes::types::String,
    SeedParam: crate::nodes::types::Int,
> IdeogramV4<PromptParam, SeedParam> {
    /// Create a new node.
...
impl<
    PromptParam: crate::nodes::types::String,
    SeedParam: crate::nodes::types::Int,
> crate::nodes::TypedNode for IdeogramV4<PromptParam, SeedParam> {
    type Output = crate::nodes::types::ImageOut;
    fn output(&self, node_id: WorkflowNodeId) -> Self::Output {
        Self::Output::from_dynamic(node_id, 0)
    }
    ...
    const NAME: &'static str = "IdeogramV4";
    const DISPLAY_NAME: &'static str = "Ideogram V4";
    const DESCRIPTION: &'static str = "Generates images using the Ideogram 4.0 model from a text prompt.";
    const CATEGORY: &'static str = "partner/image/Ideogram";
}
